...
import AllenKeyboard from './normalCZ/AllenKeyboard';
        ...
        return (
            <View style={{
                ...
                <TouchableOpacity activeOpacity={1} style={{
                    flexDirection: 'row', width: SCREEN_WIDTH - Adaption.Width(18), alignItems: 'center', justifyContent: 'center',
                }} onPress={() => {
                    ...
                    <CusBaseText style={{ fontSize: Adaption.Font(16, 14), color: '#9d9d9d' }}> 我已阅读并同意
                        <CusBaseText style={{ fontSize: Adaption.Font(15, 13), color: '#00a0e9' }}
                                        onPress={() => {
