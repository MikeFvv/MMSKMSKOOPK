...
class HomeCaiBlockView extends Component {
  ...
  render() {
   ...
   _renderItemView(item) {
    ...
    if (item.index == this.state.dataSource.length - 1 )
    {
      return (
        <TouchableOpacity activeOpacity={1} style={styles.cellStyle} onPress={() =>
            this.props.navigator.navigate('More', { backAction: this.props.backAction})
        }>
          <Image source={require('./img/home_more.png')} style={{ width: 50, height: 50, marginTop: 3 }} />
