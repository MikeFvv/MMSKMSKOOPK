...
import SegmentedControl from '../../../MyAllClass/myinformation/SegmentedControl';
									...
									<View style={styles.arrowButtomStyle}>
										...
										<View style={styles.leftArrow}>
											<TouchableOpacity style={styles.touchStyle} activeOpacity={0.3} onPress={() => {
												...
												<Image style={styles.bottomLeftImageView} source={require('../img/ic_subLeft.png')}></Image>
											</TouchableOpacity>
										</View>
										...
										<View style={styles.rightArrow}>
											<TouchableOpacity style={styles.touchStyle} activeOpacity={0.3} onPress={() => {
												...
												<Image style={styles.bottomLeftImageView} source={require('../img/ic_subRight.png')}></Image>
											</TouchableOpacity>
										</View>
									</View>
								</View>
