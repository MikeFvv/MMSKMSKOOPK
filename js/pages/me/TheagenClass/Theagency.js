    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Image style={{width: SCREEN_WIDTH, height: 145}} source={require('./Agency/ic_theagencyBack.png')}/>
                ...
                <View style={styles.rowSuperview }>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => navigate('Agenthat', {title: '代理说明'})}
                        ...
                        <View style={styles.touchItem}>
                            <Image style={styles.iconStyles} source={require('./Agency/dailishuoming.png')}></Image>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => navigate('TheStatements', {
                        ...
                        <View style={styles.touchItem}>
                            <Image style={styles.iconStyles} source={require('./Agency/dailibaobiao.png')}></Image>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => navigate('TheReportlower', {title: '下级报表'})}
                        ...
                        <View style={styles.touchItem}>
                            <Image style={styles.iconStyles} source={require('./Agency/xiajibaobiao.png')}></Image>
                ...
                <View style={styles.rowSuperview }>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => navigate('SubAccount', {title: '下级开户'})}
                                      style={styles.touchItem}>
                        <View style={styles.touchItem}>
                            <Image style={styles.iconStyles} source={require('./Agency/xiajikaihu.png')}></Image>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => navigate('TheLowerManager', {title: '下级管理'})}
                                      style={styles.touchItem}>
                        <View style={styles.touchItem}>
                            <Image style={styles.iconStyles} source={require('./Agency/xiajiguanli.png')}></Image>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => navigate('DelegeTouZhuDetial')}
                                      style={styles.touchItem}>
                        <View style={styles.touchItem}>
                            <Image style={styles.iconStyles} source={require('./Agency/touzhumingxi.png')}></Image>
                ...
                <View style={styles.rowSuperview}>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => navigate('TheDetails', {title: '交易明细'})}
                                      style={[styles.touchItem]}>
                        <View style={styles.touchItem}>
                            <Image style={styles.iconStyles}source={require('./Agency/jiaoyimingxi.png')}></Image>
