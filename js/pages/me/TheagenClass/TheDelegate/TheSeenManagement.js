  ...
  renderCell = (item) => {
    ...
    return (
      <TouchableOpacity  activeOpacity={1}  style={styles.cellStyle}
                   ...
                   <CusBaseText allowFontScaling={false} style={{marginLeft:10,color:'orange',width:80*KAdaptionWith,textAlign:'center',backgroundColor:'white'}}>{item.item.value.next_daili}</CusBaseText>
                   </View>
                   </TouchableOpacity>
              )}
            ...
            if (item.item.value.next_daili !=0) {
