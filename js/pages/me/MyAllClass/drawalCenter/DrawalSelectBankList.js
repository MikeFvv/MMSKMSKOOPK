              ...
              >
			    	...
			    	>
					    ...
					    <FlatList
					          ...
					          style={[styles.listStyle,{height:((rowHeight*this.props.dataSource.length<=200)?rowHeight*this.props.dataSource.length:200),marginTop:(SCREEN_HEIGHT-(rowHeight*this.props.dataSource.length>200?200:rowHeight*this.props.dataSource.length))}]}
					      />
			    	</TouchableOpacity>
             </Modal>
	    );
