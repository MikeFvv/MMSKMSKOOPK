                        ...
                        <TouchableOpacity
                            ...
                            <View  style={{
                                ...
                                <View style={{
                                    ...
                                    <Image style={{ width:15, height: 15,marginTop:3,marginLeft:15}} source={require('../BettingRecord/img/ic_sanjiao.png')}></Image>
                                </View>
                            </View>
                        </TouchableOpacity>)}
                        ...
                        navigation.state.params ? (
                            <TouchableOpacity activeOpacity={1} style={{
                              ...
                              <Image style={{width: 15 * KAdaptionWidth, height: 17 * KAdaptionHeight,marginLeft:5}}
                                     source={require("../BettingRecord/img/ic_xiangxia.png")}
                              />
...
//无数据页面
    listEmptyComponent() {
      if (this.jiaZai==0) {
        ...
        return (
            <View style={{width: width, height: height - height/4, justifyContent: 'center', alignItems: 'center'}}>
                <Image resizeMode={'stretch'} style={{ width: 60 * KAdaptionWidth, height: 50 * KAdaptionWidth }} source={require('../BettingRecord/img/ic_noData.png')}/>
