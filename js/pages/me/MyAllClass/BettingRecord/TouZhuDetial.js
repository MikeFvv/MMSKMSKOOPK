...
export default class TouZhuDetial extends Component {
  ...
  _xingyunPK(kaiJiangBallsArr) {
    ...
    xyViewPk10 = <View style={{ flexDirection: 'row', marginTop: Adaption.Height(20)}}>
      <Image style={{ width: Adaption.Width(40), height: Adaption.Width(44), resizeMode: 'contain' }} source={imgPk1} />
      <Image style={{ width: Adaption.Width(40), height: Adaption.Width(44), marginLeft: 5, resizeMode: 'contain' }} source={imgPk2} />
      <Image style={{ width: Adaption.Width(40), height: Adaption.Width(44), marginLeft: 5, resizeMode: 'contain' }} source={imgPk3} />
    </View>
    return xyViewPk10;
